...
import { normalizeBrokenListMarkers } from '../../../util/text/normalizeBrokenListMarkers';
...
export function renderTextWithEntities({
  ...
  ({ text, entities } = normalizeBrokenListMarkers(text, entities));
    ...
    if (entity.type === ApiMessageEntityTypes.CustomEmoji) {
      return (
        <CustomEmoji
          ...
          fallbackText={entityText || undefined}
          size={emojiSize}
          isSelectable
          withSharedAnimation

...
import type { ApiMessage, ApiStickerSetInfo } from '../../../api/types';
...
const Sticker: FC<OwnProps & StateProps> = ({
  ...
  const stickerSetInfoMaybe = stickerSetInfo as ApiStickerSetInfo | undefined;
  const isMemojiSticker = stickerSetInfoMaybe ? 'isMissing' in stickerSetInfoMaybe : false;

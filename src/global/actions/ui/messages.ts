...
import { buildCopyLine } from '../../../util/copyMessagesFormat';
...
function copyTextForMessages(global: GlobalState, chatId: string, messageIds: number[]) {
  ...
  messages.forEach((message) => {
    ...
    resultHtml.push(buildCopyLine(message.date, senderTitle, renderMessageSummaryHtml(lang, message)));
    resultText.push(buildCopyLine(message.date, senderTitle, getMessageSummaryText(lang, message, statefulContent, false, 0, true)));
  });

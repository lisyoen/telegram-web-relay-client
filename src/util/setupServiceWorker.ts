...
// TDLib backend mode: Service Worker not needed (streaming handled server-side)
const SKIP_SERVICE_WORKER = true;

if (IS_SERVICE_WORKER_SUPPORTED && !SKIP_SERVICE_WORKER) {
